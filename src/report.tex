...
\begin{table}[htbp]
    ...
    \end{tabularx}
    \renewcommand{\arraystretch}{1.0} % Reset arraystretch to default
    \caption{Optuna hyperparameter search space.} % Caption
    \label{tab:hypreal}
\end{table}
...
% This section provides plots of figures detailing optimisation results (Chapter~\ref{chap:results}) for both the experimentation phases, Head-to-Head (H2H) and Free-For-All (F4A). Both Section~\ref{sec:h2h_config} and Section~\ref{f4a_config} contain embedding specific optimal Optuna \cite{akiba2019optuna} configuration plots for H2H and F4A phases, respectively. The top 5 configurations are highlighted with red markers, unless there are less than 5 optimal configurations found. In that case, only the top 1 configuration is highlighted. As the Silhouette coefficient and Calinski-Harabasz index are maximised whereas Davies-Bouldin index is minimised, the closer a configuration is to the top left corner, the more optimal it is. Closer markers appear more opaque and further appear more translucent. 
%
% Section~\ref{sec:h2h_whisker} and Section~\ref{sec:f4a_whisker} detail embedding specific cluster size whisker plots.
%
% \subsection{H2H Configuration Plots}\label{sec:h2h_config}
% \subsubsection{MPNet}
%
% \begin{figure}[H]
%     \centering
...
%         \label{fig:mpnet_hdbscan}
%     \end{subfigure}
%     \caption{MPNet: 3-dimensional plot of the most optimal configurations found Optuna hyperparameter configurations. Top 5 configurations, based on rank aggregation are coloured in red (Section~\ref{sec:hyperparameterOpt}). More opaque markers are closer, more transparent markers are further.}
%     \label{fig:mpnet_h2h}
% \end{figure}
%
% \subsubsection{Nomic}
...
%         \label{fig:nomic_hdbscan}
%     \end{subfigure}
%     \caption{Nomic: 3-dimensional plot of the most optimal configurations found Optuna hyperparameter configurations. Top 5 configurations, based on rank aggregation are coloured in red (Section~\ref{sec:hyperparameterOpt}). More opaque markers are closer, more transparent markers are further.}
%     \label{fig:nomic_f4a}
% \end{figure}
%
% \subsection{H2H Cluster Sizes}\label{sec:h2h_whisker}
%
% \subsubsection{MPNet}
%
% % --- Figure Part 1 ---
...
%     \end{subfigure}
%     \hfill 
%     \begin{subfigure}[b]{\textwidth} % Reduced width slightly
%         \centering
%         \includegraphics[width=\textwidth]{./images/mpnet_kmedoidsvshdbscan_whisker.png}
%         \caption{k-Medoids versus HDBSCAN}
%     \end{subfigure}
%     % No main caption here yet
% \end{figure} % End of first figure part
% % --- Figure Part 2 ---
% \begin{figure}[H]
%     \ContinuedFloat
%     \centering
...
%         \caption{HDBSCAN}
%     \end{subfigure}
%     \caption{MPNet: Whisker plots of the distribution of the sizes of clusters for each configuration returned by Optuna.}
%     \label{fig:mpnet_h2h_whisker}
% \end{figure}
%
% \subsubsection{Nomic}
...
%         \caption{HDBSCAN}
%     \end{subfigure}
%     \caption{Nomic: Whisker plots of the distribution of the sizes of clusters for each configuration returned by Optuna.}
%     \label{fig:nomic_h2h_whisker}
% \end{figure}
%
% \subsection{F4A Configuration Plots}\label{sec:f4a_config}
%
% \subsubsection{MPNet}
%
% \begin{figure}[H]
...
%         \caption{\texttt{ignore\_case=False},  \texttt{keep\_punctuation=False}}
%         \label{fig:mpnet_false-false}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[b]{0.48\textwidth}
%         \centering
%         \includegraphics[width=\textwidth]{./images/mpnet_false-true.png}
%         \caption{\texttt{ignore\_case=False}, \texttt{keep\_punctuation=True}}
%         \label{fig:mpnet_false-true}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[b]{0.48\textwidth}
%         \centering
%         \includegraphics[width=\textwidth]{./images/mpnet_true-false.png}
%         \caption{\texttt{ignore\_case=True},  \texttt{keep\_punctuation=False}}
%         \label{fig:mpnet_true-false}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[b]{0.48\textwidth}
%         \centering
%         \includegraphics[width=\textwidth]{./images/mpnet_true-true.png}
%         \caption{\texttt{ignore\_case=True}, \texttt{keep\_punctuation=True}}
%         \label{fig:mpnet_true-true}
%     \end{subfigure}
%     \caption{mpnet: 3-dimensional plot of the most optimal configurations found Optuna hyperparameter configurations. Top 5 configurations, based on rank aggregation are coloured in red (Section~\ref{sec:hyperparameterOpt}). More opaque markers are closer, more transparent markers are further.}
%     \label{fig:mpnet_f4a}
% \end{figure}
...
%         \caption{\texttt{ignore\_case=True}, \texttt{keep\_punctuation=True}}
%         \label{fig:nomic_true-true}
%     \end{subfigure}
%     \caption{Nomic: 3-dimensional plot of the most optimal configurations found Optuna hyperparameter configurations. Top 5 configurations, based on rank aggregation are coloured in red (Section~\ref{sec:hyperparameterOpt}). More opaque markers are closer, more transparent markers are further.}
%     \label{fig:nomic_f4a}
% \end{figure}
%
% \subsection{F4A Cluster Sizes}\label{sec:f4a_whisker}
% \subsubsection{MPNet}
%
% % --- Figure Part 1 ---
% \begin{figure}[H] 
...
%     \end{subfigure}
%     \caption{Nomic: Whisker plots of the distribution of the sizes of clusters for each configuration returned by Optuna.}
%     \label{fig:nomic_f4a_whisker}
% \end{figure}
% \chapter{Results and Figures} % Or adjust chapter/section titling as needed
