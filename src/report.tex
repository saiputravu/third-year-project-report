...
\todo[inline, caption={}] {
    \begin{itemize}
        \item Motivate the need for sentence embedding
        \item Talk about the two types of sentence embedding (PLM, MPNet and Nomic)
        \item Talk about why we do not consider more embedding models
        \item Highlight that choosing this is critical as it affects the rest of the pipeline
    \end{itemize}
}

% \section{Dimensional Projection?}
\section{Dimensionality reduction}
\todo[inline]{Maybe combine this with dimensional projection}
...
\begin{itemize}
    ...
    \item Next steps: Fine tuning the PLM (Nomic or MPNet)
\end{itemize}
}
