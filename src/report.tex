...
\todo[inline]{ Talk about the amount of issues and stuff each year maybe ? }
...
\todo[inline,caption={}]{
    ...
    \begin{itemize}
        \item Tokenizer
        \item Stopwords
        \item TOKEN mapping (PUNC, EOS)
        \item Casing
        \item Shortcut mapping
        \item a word on using tensorflow tensors (GPU mapping)
    \end{itemize}
}

\section{Similarity Visualisation}
